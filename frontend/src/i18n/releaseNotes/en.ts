export default {
  v0_2_9: {
    items: {
      ...
      tmdbProxyDiagnostics: 'Debug logs now show whether TMDB requests use the proxy, making proxy setup easier to verify.',
      scanDuplicateLogging: 'Repeated scans no longer flood logs with duplicate task entries; scan completion logs now summarize duplicate counts.',
      hideEmailSettingsPanel: 'System Settings now hides the unfinished email notification panel until the feature is ready.',
