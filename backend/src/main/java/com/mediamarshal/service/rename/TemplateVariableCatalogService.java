    ...
    public List<TemplateVariableGroup> listVariables() {
        ...
        return List.of(
                ...
                group("EPISODE", "剧集信息", List.of(
                        item("season", "Integer", "guessit", "季号原始数值。", "3", TV_ONLY, TemplateVariableStatus.AVAILABLE),
                        item("season:02d", "String", "guessit", "季号两位补零格式。", "03", TV_ONLY, TemplateVariableStatus.AVAILABLE),
                        item("season:04d", "String", "guessit", "季号四位补零格式。", "0003", TV_ONLY, TemplateVariableStatus.AVAILABLE),
